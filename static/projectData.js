...
const data = [
    {
        ...
        info: {
            ...
            name: 'P3 Media',
            description:
                'Developed various features for Shopify merchants. An extremely popular request was a gift with purchase feature, which generated over $1.5 million for a store within a couple hours. Improved site speed, and fixed numerous JavaScript and style bugs. Built a reusable, native web component carousel to display store promotions.',
        },
        repo: '',
        image: ShopifyIcon,
    },
    {
        info: {
            ...
            name: 'Calendapp',
            description:
                'Calendapp is a web application inspired by Calendly to allow users to schedule meetings more easily. Integrated with Google Calendar API to ensure there are no conflicts in schedule. Also includes a premium plan which allows a custom length of meeting. Default 60 minute length meetings for free.',
        },
